...
export type EmbedderProvider = "openai" | "ollama" | "openai-compatible" | "gemini" | "mistral" | "mycustomai" // Add other providers as needed
...
export const EMBEDDING_MODEL_PROFILES: EmbeddingModelProfiles = {
	...
	mycustomai: {
		"d8d-embedding-text-240715": { dimension: 2560, scoreThreshold: 0.4 },
	},
}
